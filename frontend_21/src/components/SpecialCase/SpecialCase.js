...
const SpecialCase = () => {
  ...
  return (
    <div className="z-20 hidden md:flex flex-row gap-3 text-[#EE4266] ">
      <Link to="/signin">
      ...
      <Link to="/cart">
        <div className="bg-white w-16 h-[50px] rounded-md flex flex-col gap-0 justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer relative">
          <div className="flex justify-center items-center">
